...
AUTHMODE = {
    ...
    4: "WPA/WPA2-PSK", 7: "WPA2/WPA3-Personal"}
...
def handle_root(client):
    wlan_sta.active(True)
    ssids = []
    for ssid, bssid, channel, rssi, authmode, hidden in wlan_sta.scan():
        auth_name = AUTHMODE.get(authmode, '?')
        ssids.append((ssid.decode('utf-8'), auth_name))
    send_header(client)
    client.sendall("""\
        <html>
            ...
            <ul>
                <li>
                    Original code from
                        ...
                        cpopp/MicroPythonSamples</a>.
                </li>
                <li>
                    This code available at
                        <a href="https://github.com/tayfunulu/WiFiManager"
                        target="_blank" rel="noopener">
                        tayfunulu/WiFiManager</a>.
                </li>
            </ul>
        </html>
        ...
        response = """\
            <html>
                <center>
                    ...
                    <h1 style="color: #5e9ca0; text-align: center;">
                        <span style="color: #ff0000;">
                            ESP successfully connected
                            to WiFi network %(ssid)s.
                        </span>
                    </h1>
                    <br><br>
                </center>
    ...
    while True:
        ...
        try:
            ...
            try:
                ...
                pass
            # Handle form data from Safari on macOS and iOS;
            # it sends \r\n\r\nssid=<ssid>&password=<password>
            try:
                request += client.recv(1024)
                print(
                    "Received form data after \\r\\n\\r\\n(i.e. "
                    "from Safari on macOS or iOS)")
            except OSError:
                pass
